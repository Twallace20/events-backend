...
event1 = Event.create([{location: 'Terminal 5', date: '2020-06-03', event_name: 'Office-Party', user_id: User.all.sample.id, event_planner_id: EventPlanner.all.sample.id}])
event2 = Event.create([{location: 'Epic Events', date: '2020-12-30', event_name: 'Wedding', user_id: User.all.sample.id, event_planner_id: EventPlanner.all.sample.id}])
event3 = Event.create([{location: 'Blue Rose', date: '2021-01-15', event_name: 'Graduation-Party', user_id: User.all.sample.id, event_planner_id: EventPlanner.all.sample.id}])
event4 = Event.create([{location: 'Grande Gallas', date: '2021-03-13', event_name: 'Wedding', user_id: User.all.sample.id, event_planner_id: EventPlanner.all.sample.id}])
event5 = Event.create([{location: 'Night Bar', date: '2021-03-21', event_name: 'Birthday', user_id: User.all.sample.id, event_planner_id: EventPlanner.all.sample.id}])